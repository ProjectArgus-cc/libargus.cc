...
> [!NOTE]
> **v1.7.8 development — release identity, portable builds and lifetime safety.**
...
dependencies {
    // Core Java Panama FFM Bindings & High-Level API
    implementation("cc.projectargus:libargus-core:1.7.8")

    // Optional: Platform Native Runtime Provider (Automatic SPI Extraction)
    runtimeOnly("cc.projectargus:libargus-native-linux-cpu:1.7.8")
}
```
