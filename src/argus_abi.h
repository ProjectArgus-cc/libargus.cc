...
inline const auto & argus_diagnostic_info() {
    ...
    static const Info info = [] {
        ...
        append(";%zu:%zu:%zu,%zu,%zu,%zu,%zu,%zu,%zu", sizeof(argus_perf_timings_t), alignof(argus_perf_timings_t), offsetof(argus_perf_timings_t, t_start_ms), offsetof(argus_perf_timings_t, t_load_ms), offsetof(argus_perf_timings_t, t_p_eval_ms), offsetof(argus_perf_timings_t, t_eval_ms), offsetof(argus_perf_timings_t, n_p_eval), offsetof(argus_perf_timings_t, n_eval), offsetof(argus_perf_timings_t, n_reused));
        append("\n");
        return result;
    }();
    return info;
